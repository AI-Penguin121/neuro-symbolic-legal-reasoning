...
Based on these requirements, the paper surveys and compares different approaches to neuro-symbolic legal reasoning.

The reviewed methods are organized according to their underlying technical approach, including combinations of large language models with:
...
📄 **[Read the seminar paper](./Seminar_Paper_final.pdf)**
